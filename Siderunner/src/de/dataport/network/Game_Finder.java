...
public class Game_Finder implements Game_FinderInterface{
	...
	/**
	 * Fragt ab, ob ein Client in der Liste wartet. Ist dies der Fall wird dieser an den Anfragenden zurückgegeben, um eine Verbindung aufzubauen.
	 * @return Gibt einen Client zurück der ebenfalls derzeit auf der Suche nach einem Spiel ist.
	 */
	@Override
 ...
 * @param client Ein Client, um eine Verbindung aufbauen zu können
 * @return Gibt einen boolschen Wert zurück, ob die Eintragung erfolgreich war.
 */
	@Override
