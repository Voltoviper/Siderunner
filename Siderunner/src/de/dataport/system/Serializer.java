...
public abstract class Serializer {
	...
	public static void write(Level level, Component thisInstance) throws Exception {
		File f = getFileToChoose(thisInstance, JFileChooser.SAVE_DIALOG, "Speichern unter...");
		if (f != null) {
	...
	public static Level read(Component thisInstance) throws Exception {
		File f = getFileToChoose(thisInstance, JFileChooser.OPEN_DIALOG, "Öffnen...");
		if (f != null) {
	...
	private static File getFileToChoose(Component openOnInstance, int jFileChooserDialog, String text) {
		...
		FileNameExtensionFilter markUpFilter = new FileNameExtensionFilter("Markup: xml", "xml");
